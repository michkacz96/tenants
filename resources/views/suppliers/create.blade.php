...
@section('content')
    ...
    <div class="mt-3">
        {!! Form::open(['action' => 'App\Http\Controllers\SuppliersController@store', 'method' => 'POST']) !!}
        <div class="row">
            ...
            <div class="form-group col-md-12 col-lg-3">
                ...
                {{Form::text('supplier_code', '', ['class' => 'form-control', 'placeholder' => 'Short Name', 'maxlength' => '30', 'required'])}}
            </div>
            <div class="form-group col-md-12 col-lg-9">
                {{Form::label('supplier_name', 'Full Name')}}
                {{Form::text('supplier_name', '', ['class' => 'form-control', 'placeholder' => 'Full Name', 'required'])}}
            </div>
        ...
        <div class="my-3 clearfix">
            {{Form::submit('Add new supplier', ['class' => 'btn btn-primary float-end'])}}
        </div>
        {!! Form::close() !!}
    </div>
